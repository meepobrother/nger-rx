import { Inject, Injectable, OnDestroy, Provider } from '@nger/core';
...
export class ReducerManager extends BehaviorSubject<ActionReducer<any, any>>
    ...
    constructor(
        ...
        @Inject({ token: INITIAL_STATE }) private initialState: any,
        @Inject({ token: INITIAL_REDUCERS }) private reducers: ActionReducerMap<any, any>,
        @Inject({ token: REDUCER_FACTORY })
