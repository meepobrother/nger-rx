...
export class StoreFeatureModule implements OnDestroy {
    constructor(
        @Inject({ token: _STORE_FEATURES }) private features: StoreFeature<any, any>[],
        @Inject({ token: FEATURE_REDUCERS }) private featureReducers: ActionReducerMap<any>[],
            ...
            providers: [
                {
                    ...
                    deps: [[Store, InjectFlags.Optional, InjectFlags.SkipSelf]],
                },
